...
class UserTab(object):
    ...
    def __init__(self):
        ...
        div_row1 = Button(description='---ECM initialization parameters---', disabled=True, layout=divider_button_layout)
        ...
        div_row2 = Button(description='---Lesion initialization parameters---', disabled=True, layout=divider_button_layout)
        ...
        div_row3 = Button(description='---Cell properties---', disabled=True, layout=divider_button_layout)

        div_row4 = Button(description='-Both cell types-', disabled=True, layout=divider_button_layout)
        ...
        div_row5 = Button(description='-Leader cell type parameters-', disabled=True, layout=divider_button_layout)
        ...
        div_row6 = Button(description='-Follower cell type parameters-', disabled=True, layout=divider_button_layout)
        ...
        param_name17 = Button(description='default_ECM_sensitivity', disabled=True, layout=name_button_layout)
        ...
        param_name18 = Button(description='rho_L', disabled=True, layout=name_button_layout)
        ...
        param_name19 = Button(description='rho_H', disabled=True, layout=name_button_layout)
        ...
        param_name20 = Button(description='rho_I', disabled=True, layout=name_button_layout)
        ...
        div_row7 = Button(description='---Microenvironment initialization and other parameters---', disabled=True, layout=divider_button_layout)

        param_name22 = Button(description='chemotactic_substrate_decay_rate', disabled=True, layout=name_button_layout)
        ...
        param_name23 = Button(description='chemical_field_setup', disabled=True, layout=name_button_layout)
        ...
        param_name24 = Button(description='angle_of_chemical_field_gradient', disabled=True, layout=name_button_layout)
        ...
        param_name25 = Button(description='ECM_orientation_setup', disabled=True, layout=name_button_layout)
        ...
        div_row8 = Button(description='---Model Selection parameters---', disabled=True, layout=divider_button_layout)
        ...
        param_name27 = Button(description='discrete_ECM_remodeling', disabled=True, layout=name_button_layout)
        ...
        units_button10 = Button(description='mmHg/min', disabled=True, layout=units_button_layout) 
        units_button10.style.button_color = 'tan'
        units_button11 = Button(description='microns/minute', disabled=True, layout=units_button_layout) 
        units_button11.style.button_color = 'lightgreen'
        units_button12 = Button(description='minutes', disabled=True, layout=units_button_layout) 
        ...
        units_button14 = Button(description='micron/minute', disabled=True, layout=units_button_layout) 
        ...
        units_button21 = Button(description='micron/minute', disabled=True, layout=units_button_layout) 
        units_button21.style.button_color = 'lightgreen'
        units_button22 = Button(description='micron/minute', disabled=True, layout=units_button_layout) 
        ...
        units_button29 = Button(description='1/minutes', disabled=True, layout=units_button_layout) 
        ...
        row1 = [param_name1, self.initial_anisotropy, units_button2, desc_button1] 
        row2 = [param_name2, self.initial_ECM_density, units_button3, desc_button2] 
        row3 = [param_name3, self.cell_setup, units_button5, desc_button3] 
        row4 = [param_name4, self.tumor_radius, units_button6, desc_button4] 
        row5 = [param_name5, self.initial_leader_cell_fraction, units_button7, desc_button5] 
        row6 = [param_name6, self.oxygen_uptake, units_button10, desc_button6] 
        row7 = [param_name7, self.default_cell_speed, units_button11, desc_button7] 
        row8 = [param_name8, self.default_persistence_time, units_button12, desc_button8] 
        row9 = [param_name9, self.leader_adhesion, units_button14, desc_button9] 
        row10 = [param_name10, self.leader_repulsion, units_button15, desc_button10] 
        row11 = [param_name11, self.oxygen_migration_bias_for_leaders, units_button16, desc_button11] 
        row12 = [param_name12, self.anisotropy_increase_rate, units_button17, desc_button12] 
        row13 = [param_name13, self.fiber_realignment_rate, units_button18, desc_button13] 
        row14 = [param_name14, self.default_ECM_density_target, units_button19, desc_button14] 
        row15 = [param_name15, self.follower_adhesion, units_button21, desc_button15] 
        row16 = [param_name16, self.follower_repulsion, units_button22, desc_button16] 
        row18 = [param_name17, self.default_ECM_sensitivity, units_button23, desc_button18] 
        row19 = [param_name18, self.rho_L, units_button24, desc_button19] 
        row20 = [param_name19, self.rho_H, units_button25, desc_button20] 
        row21 = [param_name20, self.rho_I, units_button26, desc_button21] 
        row22 = [param_name21, self.default_hysteresis_bias, units_button27, desc_button22] 
        row25 = [param_name22, self.chemotactic_substrate_decay_rate, units_button29, desc_button25] 
        row26 = [param_name23, self.chemical_field_setup, units_button30, desc_button26] 
        row27 = [param_name24, self.angle_of_chemical_field_gradient, units_button31, desc_button27] 
